#!/usr/bin/env ruby
require_relative '../lib/logic' #! This is from a logic side which will come in the next milestone 
status = Game_status.new #! This is from a logic side which will come in the next milestone 
utils = Game_utils.new #! This is from a logic side which will come in the next milestone 
